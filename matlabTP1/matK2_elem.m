function [Kel] = matK2_elem(S1, S2, S3)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% mat_elem :
...
A_int = -9/32*A(dF(1)*1/3+x1,dF(2)*1/3+y1)+25/96*(A(dF(1)*1/5+x1,dF(2)*1/5+y1)+A(dF(1)*1/5+x1,dF(2)*3/5+y1)+A(dF(1)*3/5+x1,dF(2)*1/5+y1));
